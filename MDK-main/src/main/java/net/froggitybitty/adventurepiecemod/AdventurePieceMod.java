...
public class AdventurePieceMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "adventurepiecemod";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public AdventurePieceMod(IEventBus modEventBus, ModContainer modContainer){
